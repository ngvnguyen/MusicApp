...
@AndroidEntryPoint
class PlaylistItemSavedFragment : BaseBottomSheetFragment<FragmentItemSavedBinding>() {
    @Inject
    lateinit var playerHelper: PlayerHelper

    private lateinit var adapter: ItemAdapter<Playlist>
    ...
    override fun initView() {
        ...
        adapter = object : ItemAdapter<Playlist>(
            itemClick = {
            ...
            override fun bind(
                ...
                binding.itemAuthor.text = data.userName
    ...
    fun collectData(){
        ...
        scope = lifecycleScope.launch{
            dbViewModel.playlists.collectLatest {
                adapter.setData(it)
            }
        }
    }
